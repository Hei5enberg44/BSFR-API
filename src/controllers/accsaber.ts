...
import { AccSaberPlayerScoresModel } from '../models/cubestalker/playerScore.model.js'
    ...
    static async getPlayerScores(accSaberId: string): Promise<PlayerScore[]> {
        ...
        try {
            ...
            do {
                ...
                hasNextPage =
                    scoresRequest.data.accSaberScores.pageInfo.hasNextPage
                ...
                for (const playerScore of playerScores) {
                    ...
                    if (cachedScore) {
                        if (
                            playerScore.score !== cachedScore.playerScore.score
                        ) {
