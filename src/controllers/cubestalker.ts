...
export class CubeStalker {
    ...
    private static lightenDarkenColor(color: number, magnitude: number) {
    ...
    private static drawImageScaled(img: Image, ctx: CanvasRenderingContext2D) {
    ...
    public static async getCard(
        ...
        ctx.save()
        this.roundedImage(ctx, 52, 372, 1796, 66, 8)
        ctx.clip()
